...
INFO = [
    ("__header__", "Arya Benade", ""),
    ("__rule__", "", ""),
    ("Role",     "Web Developer / React Specialist", "val"),
    ("Edu",      "B.Sc. IT, Ghanshyamdas Saraf College · Class of 2025", "val"),
    ("Focus",    "Frontend Engineering · React / Next.js / Full-Stack", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Core",     "React.js · Next.js · JavaScript (ES6+)", "val"),
    ("Styling",  "HTML5 · CSS3 · Tailwind CSS · Framer Motion", "val"),
    ("Backend",  "Node.js · Express · PostgreSQL · MongoDB", "val"),
    ("Cloud",    "Supabase · Convex · Vercel · Clerk Auth", "val"),
    ("Tools",    "Git & GitHub · OpenAI · Firecrawl · Cloudinary", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("ZenAi",    "Multi-tool AI productivity platform (PERN stack)", "warn"),
    ("ZenTrack", "Real-time price tracker · Next.js + Supabase", "warn"),
    ("ZenAura",  "Event management & discovery platform · Convex", "warn"),
    ("ZenResume","AI-assisted & ATS-friendly resume builder", "warn"),
    ("ZenTask",  "Animated project management tool · React Router", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Cert",     "Complete Web Dev · React (Zero to Hero) · Udemy", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "aryabenade.vercel.app", "accent"),
    ("GitHub",   "github.com/aryabenade", "accent"),
    ("LinkedIn", "linkedin.com/in/aryabenade", "accent"),
    ("Mail",     "aryabenade@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8"> Web Developer / React Specialist </tspan>'
